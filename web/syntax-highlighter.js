function w3CodeColor(elmnt, mode) {
	...
	let cssselectorcolor = "green";
	let csspropertycolor = "white";
	let csspropertyvaluecolor = "green";
	let cssdelimitercolor = "white";
	let cssimportantcolor = "red";

	let jscolor = "white";
	let jskeywordcolor = "orange";
	let jsstringcolor = "darkgreen";
	let jsnumbercolor = "red";
	let jspropertycolor = "yellow";
	...
	function htmlMode(txt) {
		...
		comment = new xtract(rest, "&lt;!--", "--&gt;", commentMode, "W3HTMLCOMMENTPOS");
		rest = comment.rest;
...
// Call for each pre tag
const pre = document.getElementsByTagName('pre');
for (let i = 0; i < pre.length; i++) {
	console.log("hi")

	// get data-language attribute
	const lang = pre[i].getAttribute('data-lang');

	w3CodeColor(pre[i], lang);
}